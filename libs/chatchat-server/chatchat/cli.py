...
import sys, os
sys.path.append('/Langchain-Chatchat-0.3.1')
sys.path.append('/Langchain-Chatchat-0.3.1/libs/chatchat-server')
sys.path.append('/Langchain-Chatchat-0.3.1/libs/chatchat-server/chatchat')
...
def init(
    ...
    if recreate_kb:
        ...
        print('所有初始化已完成，执行 chatchat start -a 启动服务。')
